// lib/screens/schedule_screen.dart (perbaikan dengan menggunakan TeamProvider)
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  Expanded(
                    child: Text(
                      Provider.of<TeamProvider>(context, listen: false).getTeamById(match.homeTeamId)?.name ?? 'Home',
                      textAlign: TextAlign.center,
                      style: const TextStyle(
                        color: Colors.white,
                        fontWeight: FontWeight.w700,
                  ...
                  Expanded(
                    child: Text(
                      Provider.of<TeamProvider>(context, listen: false).getTeamById(match.awayTeamId)?.name ?? 'Away',
                      textAlign: TextAlign.center,
                      style: const TextStyle(
                        color: Colors.white,
                        fontWeight: FontWeight.w700,
                  ...
                  Expanded(
                    child: ElevatedButton(
                      ...
                      onPressed: () async {
                        ...
                        try {
                          await matchProvider.addMatch(updatedMatch);
                          if (ctx.mounted) {
                            Navigator.pop(ctx);
