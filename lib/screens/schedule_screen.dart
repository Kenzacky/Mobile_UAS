// lib/screens/schedule_screen.dart (FIXED)
              ...
              children: [
                Container(
                  ...
                  child: Icon(
                    ...
                    size: 50,
                    color: const Color(0xFFD4AF37).withAlpha(128), // 0.5*255
                  ),
                ),
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(
                    color: const Color(0xFFD4AF37).withAlpha(38), // 0.15*255
                  ),
                ),
                child: Row(
                  children: [
                    const Icon(Icons.calendar_today_rounded, color: Color(0xFFD4AF37), size: 20),
              ...
              SizedBox(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (ctx, index) {
                    ...
                    return Padding(
                      padding: EdgeInsets.only(left: isFirst ? 0 : 8, right: 8),
              ...
              // Matches by Week
              ...weeks.map((week) {
                final matches = scheduleProvider.getMatchesByWeek(week);
  ...
  Widget _buildMatchCard({
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: isFinished
              ? const Color(0xFF4CAF50).withAlpha(77) // 0.3*255
              : const Color(0xFFD4AF37).withAlpha(25), // 0.1*255
        ),
        boxShadow: isFinished
            ? [
          BoxShadow(
            color: const Color(0xFF4CAF50).withAlpha(25), // 0.1*255
            blurRadius: 8,
          )
        ]
            : null,
                  ...
                  Expanded(
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        filled: true,
                        fillColor: const Color(0xFFD4AF37).withAlpha(25), // 0.1*255
                        hintStyle: TextStyle(
                  ...
                  Expanded(
                    child: ElevatedButton(
                      ...
                      onPressed: () async {
                        ...
                        // Update match di Firestore via MatchProvider
